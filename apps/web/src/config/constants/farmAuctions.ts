...
export const whitelistedBidders: FarmAuctionBidderConfig[] = [
  ...
  {
    account: '0x34922627B7244D47729F03B33EB45D8D263D116B',
    farmName: 'PLAY-USDT',
    tokenAddress: '0xD069599E718f963bD84502b49ba8F8657fAF5B3a',
    quoteToken: bscTokens.usdt,
    tokenName: 'PLAY',
    projectSite: 'https://xcadnetwork.com/play',
  },
  {
    account: '0xd9b4753Cd798Bc2F24F6FB6c325A7aEe89D46cB3',
    farmName: 'CGPT-BUSD',
    tokenAddress: '0x9840652DC04fb9db2C43853633f0F62BE6f00f98',
    quoteToken: bscTokens.busd,
    tokenName: 'CGPT',
    projectSite: 'https://www.chaingpt.org/',
  },
  {
    ...
    tokenName: 'CGV',
    projectSite: 'https://www.cogitoprotocol.com/',
  },
].map((bidderConfig) => ({
  ...bidderConfig,
