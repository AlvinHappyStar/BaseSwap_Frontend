  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active BaseSwap Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold BASE'),
      bodyText: [t('Each NFT costs BASE to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
