...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and BASE pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and BASE pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from BASE pool', data)
  }
