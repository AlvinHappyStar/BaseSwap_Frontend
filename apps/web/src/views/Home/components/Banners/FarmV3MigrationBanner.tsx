      ...
      <S.Inner>
        <S.LeftWrapper>
          <Flex flexDirection={['column', 'row']} mb={['8px', '8px', '12px']}>
            ...
            <Title>{isMobile ? t('PCS v3 Migration') : t('BaseSwap v3 Migration')}</Title>
          </Flex>
          <StyledBox>{t('Migrate to continue farming BASE rewards and earning trading fees.')}</StyledBox>
