...
const Multiplier: React.FC<React.PropsWithChildren<MultiplierProps>> = ({ multiplier }) => {
  ...
  const tooltipContent = (
    <>
      <Text>
        {t(
          'The Multiplier represents the proportion of BASE rewards each farm receives, as a proportion of the BASE produced each block.',
        )}
      </Text>
      <Text my="24px">
      ...
      <Text>
        {t(
          'We have recently rebased multipliers by a factor of 10, this is only a visual change and does not affect the amount of BASE each farm receives.',
        )}
      </Text>
      <Link
        mt="8px"
