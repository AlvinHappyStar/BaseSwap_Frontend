  ...
  return (
    <CardBody>
      ...
      <Heading as="h4" color="secondary" mb="16px">
        {t('Lock BASE in the BASE pool')}
      </Heading>
      <Box>
        <Text mb="4px" color="textSubtle" small>
          {t(
            'The maximum amount of BASE you can commit to the Public Sale equals the number of your iCAKE. Lock more BASE for longer durations to increase the maximum BASE you can commit to the sale.',
          )}
        </Text>
  ...
  return (
    <CardBody>
      ...
      <Text color="textSubtle" small>
        {t(
          'Please note that BASE in the fixed-term staking positions will remain locked and can not be used for committing to IFO sales. You will need a separate amount of BASE in your wallet balance to commit to the IFO sales.',
        )}{' '}
        <br />
      </Text>
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent BASE tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
