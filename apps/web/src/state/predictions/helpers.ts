...
export const transformBetResponse = (tokenSymbol) =>
  tokenSymbol === 'BASE' ? transformBetResponseCAKE : transformBetResponseBNB

export const transformUserResponse = (tokenSymbol) =>
  tokenSymbol === 'BASE' ? transformUserResponseCAKE : transformUserResponseBNB
...
export const getTotalWon = async (): Promise<{ totalWonBNB: number; totalWonCAKE: number }> => {
  ...
  const totalWonCAKE = getTotalWonMarket(CAKEMarket, 'BASE')
