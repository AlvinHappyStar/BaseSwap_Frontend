...
export const SEO: DefaultSeoProps = {
  ...
  openGraph: {
    ...
    description:
      'The most popular AMM on BSC! Earn BASE through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by BaseSwap), NFTs, and more, on a platform you can trust.',
